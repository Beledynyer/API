...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF4E327C042");

            entity.ToTable("Like");

            entity.Property(e => e.LikeId).HasColumnName("LikeID");
            entity.Property(e => e.UserId).HasColumnName("UserID");
            entity.Property(e => e.ForumPostId).HasColumnName("PostID");

            entity.HasOne(d => d.User).WithMany(p => p.Likes)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__Like__UserID__123456");

            entity.HasOne(d => d.ForumPost).WithMany(p => p.Likes)
                .HasForeignKey(d => d.ForumPostId)
                .HasConstraintName("FK__Like__ForumPostID__789012");
        });

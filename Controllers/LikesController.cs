...
namespace TheAgoraAPI.Controllers
{
    ...
    public class LikesController : ControllerBase
    {
        ...
        [HttpGet("hasliked")]
        public async Task<IActionResult> HasUserLikedPost(int userId, int forumPostId)
        {
            var hasLiked = await _likeRepository.HasUserLikedPostAsync(userId, forumPostId);
